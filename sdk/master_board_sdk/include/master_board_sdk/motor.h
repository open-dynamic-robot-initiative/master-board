...
public:
  ...
  bool HasIndexBeenDetected() const;
  bool GetIndexToggleBit() const;
  ...
  double get_velocity() const { return this->velocity; };
  double get_current() const { return this->current; };
  bool get_is_enabled() const { return this->is_enabled; };
  bool get_is_ready() const { return this->is_ready; };
  bool get_has_index_been_detected() const { return this->has_index_been_detected; };
  bool get_index_toggle_bit() const { return this->index_toggle_bit; };
  double get_position_ref() const { return this->position_ref; };
  double get_velocity_ref() const { return this->velocity_ref; };
  double get_current_ref() const { return this->current_ref; };
  double get_current_sat() const { return this->current_sat; };
  double get_kp() const { return this->kp; };
  double get_kd() const { return this->kd; };
  bool get_enable() const { return this->enable; };
  bool get_enable_position_rollover_error() const { return this->enable_position_rollover_error; };
  bool get_enable_index_toggle_bit() const { return this->enable_index_toggle_bit; };
  bool get_enable_index_offset_compensation() const { return this->enable_index_offset_compensation; };
